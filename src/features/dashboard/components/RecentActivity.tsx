  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      <Card className="p-6 space-y-3">
        <SectionTitle title="Last Vehicles Added" right={<span className="text-xs text-slate-500">Top 5</span>} />
      ...
      <Card className="p-6 space-y-3">
        <SectionTitle title="Recent Maintenance" right={<span className="text-xs text-slate-500">Latest 5</span>} />
        <div className="space-y-2">
      ...
      <Card className="p-6 space-y-3">
        <SectionTitle title="Recent Assignments" right={<span className="text-xs text-slate-500">Latest 5</span>} />
        <div className="space-y-2">
