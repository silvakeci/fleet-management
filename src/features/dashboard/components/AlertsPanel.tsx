      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm text-rose-800 font-semibold">Overdue Maintenance</div>
              <div className="text-2xl font-semibold mt-1 text-rose-900">
                {data.overdue.length.toLocaleString()}
              </div>
              <div className="text-xs text-rose-700 mt-1">Requires immediate attention</div>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm text-amber-900 font-semibold">Service Due Soon</div>
              <div className="text-2xl font-semibold mt-1 text-amber-950">
                {data.dueSoon.length.toLocaleString()}
              </div>
              <div className="text-xs text-amber-800 mt-1">Due within 30 days</div>
            </div>
